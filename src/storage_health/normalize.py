...
def normalize(
    ...
    return TelemetryRecord(
        ...
        health={
            ...
            "percentage_used": _first(_nested(nvme, "percentage_used"), _nested(smart, "nvme_smart_health_information_log", "percentage_used"), sysfs.get("percentage_used")),
            "available_spare_percent": _first(_nested(nvme, "avail_spare"), _nested(smart, "nvme_smart_health_information_log", "available_spare")),
        },
        usage={
            "power_on_hours": _first(_nested(nvme, "power_on_hours"), _nested(smart, "power_on_time", "hours"), _nested(smart, "nvme_smart_health_information_log", "power_on_hours"), sysfs.get("power_on_hours")),
            ...
            "start_stop_cycles": sysfs.get("start_stop_cycles"),
        ...
        temperature={
            "celsius": _first(smart_temp, _kelvin_to_celsius(nvme_temp), sysfs.get("temperature_celsius")),
            "maximum_celsius": sysfs.get("temperature_max_celsius"),
        },
        errors={
            ...
            "read_total": sysfs.get("read_errors_total"),
            "write_total": sysfs.get("write_errors_total"),
            "read_corrected": sysfs.get("read_errors_corrected"),
            "write_corrected": sysfs.get("write_errors_corrected"),
        },
        collection={
